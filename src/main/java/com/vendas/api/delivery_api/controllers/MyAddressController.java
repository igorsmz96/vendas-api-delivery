...
public class MyAddressController {
        ...
        @PostMapping
        public ResponseEntity<AddressResponse> createAddress(@AuthenticationPrincipal User userAuth, @RequestBody AddressRequest addressRequest){
        ...
        @PatchMapping("/{id}")
        public ResponseEntity<AddressResponse> updatePartial(@AuthenticationPrincipal User userAuth ,@PathVariable("id") Long addressId, @RequestBody AddressRequest addressRequest){
